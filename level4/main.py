...
app.include_router (university.router, 
                    dependencies=[Depends(call_api_gateway)], prefix='/level4')
...
def exception_handler_student(request: Request, exc: RedirectStudentPortalException) -> Response:
    return RedirectResponse(url='http://localhost:8000/level4/student/index')
...
def exception_handler_faculty(request: Request, exc: RedirectFacultyPortalException) -> Response:
    return RedirectResponse(url='http://localhost:8000/level4/faculty/index')
...
def exception_handler_library(request: Request, exc: RedirectLibraryPortalException) -> Response:
    return RedirectResponse(url='http://localhost:8000/level4/library/index')
  
app.mount("/level4/student", student_main.student_app)
app.mount("/level4/faculty", faculty_main.faculty_app)
app.mount("/level4/library", library_main.library_app)
